...
const getSubmarineListForDisplay_1 = require("../commands/functions/getSubmarineListForDisplay");
const checkTime = () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const submarineList = yield (0, getSubmarineListForDisplay_1.getSubmarineListForDisplay)('All');
